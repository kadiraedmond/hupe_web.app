...
onBeforeMount(() => {
  companieStore.setCompanieCars(savedUser.uid || authStore.user.uid) // authStore.user.uid
  promotionStore.setCompaniePromotionCars(savedUser.uid || authStore.user.uid)
})
