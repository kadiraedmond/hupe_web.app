...
onBeforeMount(async () => {
  await userStore.setReservationTickets(savedUser.uid || authStore.user.uid || 'MIKsd9oIvxP860LDUMm9XNpvwzV2')
          ...
          <div class="col-md-12">
            ...
            >
              <div class="row">
                ...
                <div class="col-4">{{ enAttente.totalNumber }}</div>
              </div>
            </boutton>
          </div>
          <div class="col-md-12 mt-4">
            ...
            >
              <div class="row">
                ...
                <div class="col-4">{{ valides.totalNumber }}</div>
              </div>
            </boutton>
          </div>
          <div class="col-md-12 mt-4">
            ...
            >
              <div class="row">
                ...
                <div class="col-4">{{ annulees.totalNumber }}</div>
              </div>
            </boutton>
          </div>
          <div class="col-md-12 mt-4">
            ...
            >
              <div class="row">
                ...
                <div class="col-4">{{ confirmees.totalNumber }}</div>
              </div>
            </boutton>
          </div>
          <div class="col-md-12 mt-4">
            ...
            >
              <div class="row">
                ...
                <div class="col-4">{{ utilisees.totalNumber }}</div>
              </div>
            </boutton>
          </div>
        </div>
      ...
      <div class="col-md-6">
        ...
        >
          <div class="row">
            ...
            <div class="col-4">{{ reportees.totalNumber }}</div>
          </div>
        </boutton>
      </div>
    </div>
