...
<template>
    ...
    <ul class="slider-container py-4" id="slider2">
        <li style="margin-left: 14px;" v-for="(companie, index) in companieStore.transportCompanies" :key="index" >
    ...
    <button type="button" class="slider-nav" aria-label="Aller à la page précédente" _mstaria-label="214682" _msthash="250"></button>
    <button type="button" class="slider-nav slider-nav-next" aria-label="Aller à la suivante" _mstaria-label="118885" _msthash="251"></button>
</div>
  </template>
