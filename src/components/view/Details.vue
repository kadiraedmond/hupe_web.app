      ...
      <div class="col-lg-12">
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            <li class="nav-item" role="presentation">
              <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home-tab-pane" type="button" role="tab" aria-controls="home-tab-pane" aria-selected="true">Programmes</button>
            </li>
                    ...
                    <div class="col-md-6">
                        <div class="card h-100" id="card_compagnie">
                            <div class="card-body">
                                 <div class="row">
                                    <div class="col-md-6">
                                       <h6> Compagnies KOUDI</h6>
                                    </div>
                                    <div class="col-md-6 text-end">
                                      <h6> <strong>prix :</strong> 2000 FCFA</h6> 
                                    </div>

                                    <div class="col-md-12 mt-3">
                                        <p>Escales : lorenipsun</p>
                                    </div>
                                    <div class="col-md-12">
                                        <p>Convocation : 8h55min</p>
                                    </div>

                                    <div class="col-md-6">
                                        <button class="btn btn-primary" style="background-color: #7A7A7A; border-color:#7A7A7A" >Départ à 9h00 min</button>
                                     </div>
                                    <div class="col-md-6 text-end">
