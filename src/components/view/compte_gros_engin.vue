...
const addPromotion = (_id) => {
  ...
  axios({
    ...
    console.log('Insert');
    this.getAllVehiculeEnPromotion();
...
const getAllVehiculeEnPromotion = () => {
  axios({
    headers: {
      "Access-Control-Allow-Origin": "*",
      "Access-Control-Allow-Methods": "GET, POST, PATCH, PUT, DELETE, OPTIONS",
    ...
    // urls: "hupe-api-beta-test.cyclic.app//api/promotion/for-me?from_company=" + compagnieId,
    url: "https://hupe-api-beta-test.cyclic.app/api/promotion/vehicule_en_promotion/all",
    method: 'GET',
  }).then((response) => {
    console.log('Response: ', + response.data)
            ...
            <div class="tab-content" id="myTabContent">
                ...
                <div class="row mt-4">
                  ...
                  <div class="col-md-6 text-end">
                    ...
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal"
                      ...
                      <img src="/public/assets/img/icone/plus.png" class="img-fluid " alt="..."> Ajouter
                    </button>
                                ...
                                <div class="row row-clols-md-5">
                                  <div class="col">
                                    ...
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                      data-bs-target="#exampleModal4" style="    background-color:rgb(33 153 53 / 58%);
                                      border-color: rgb(33 153 53 / 58%);">
                                      <img src="/public/assets/img/icone/edit.png" class="img-fluid " alt="...">
                                    </button>
                                        ...
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-body">
                                            <form class="row g-3 needs-validation text-start" novalidate>
                                              ...
                                              <div class="col-md-12">
                                                <label for="validationCustom02" class="form-label">Ajouter une
                                                  images</label>
                                                <input type="file" class="form-control" id="validationCustom02" required>
                                  ...
                                  <div class="col">
                                    ...
                                    <button class="btn btn-primary" style="    background-color: #219935;
                                      border-color: #219935;"><img src="/public/assets/img/icone/star.png"
                                  ...
                                  <div class="col">
                                    ...
                                    <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                      ...
                                      style=" background-color: #219935; border-color: #219935;">
                                      <img src="/public/assets/img/icone/promotion.png" class="img-fluid " alt="...">
                                    </button>
                                    ...
                                    <div class="modal fade" id="exampleModal1" tabindex="-1"
                                      ...
                                      <div class="modal-dialog">
                                        <div class="modal-content">
                                          <div class="modal-header">
                                            <h1 class="modal-title fs-5" id="exampleModalLabel">Promouvoir un vehicule
                                            </h1>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                              aria-label="Close"></button>
                                          </div>
                                          <div class="modal-body">
                                            <form class="row g-3 needs-validation text-start" method="POST"
                                              @submit.prevent='addPromotion(vehicule._id)' novalidate>
                                              <div class="col-md-12">
                                                <label for="validationCustom01" class="form-label">Taux de
                                                  réduction</label>
                                                <input type="text" v-model="promotion.taux_de_reduction"
                                                  class="form-control" id="validationCustom01" required>

                                              </div>
                                              <div class="col-md-12">
                                                <label for="validationCustom02" class="form-label">Montant</label>
                                                <input type="text" class="form-control" v-model="promotion.montant"
                                              ...
                                              <div class="col-md-6">
                                                ...
                                                <input type="date" class="form-control" v-model="promotion.date_de_debut"
                                                  id="validationCustom01" required>

                                              </div>
                                              <div class="col-md-6">
                                                <label for="validationCustom02" class="form-label">Date de fin</label>
                                                <input type="date" class="form-control" v-model="promotion.date_de_fin" n
                                                  id="validationCustom02" required>
                                  ...
                                  <div class="col">
                                    ...
                                    <button class="btn btn-primary" style="    background-color: #219935;
                                      border-color: #219935;"><img src="/public/assets/img/icone/unlock.png"
                                        class="img-fluid " alt="..."> </button>
              ...
              <div class="tab-pane fade" id="profile-tab-pane" role="tabpanel" aria-labelledby="profile-tab" tabindex="0">
                <div class="row row-cols-1 row-cols-md-3 mt-4 g-4">
                  ...
                  <div class="col mb-3" v-for="(promotion, index) in vehiculeEnPromotion.list" :key="index">
                      ...
                      <div class="row" style="padding: 6px;">
                        <div class="col-md-12 d-flex">
                          ...
                          <p style="font-size: 12px;  margin-left: 5px;  margin-top: 6px;">
                            <i class='bx bxs-map' style="font-size: 15px; color: #848484;"></i> {{ promotion.adresse }}
                          </p>
                                    ...
                                    <div class="col-md-12 text-start">
                                      <p class="text-white">
                                        <button class="btn btn-primary border-0 text-white"
                                          style="background: #0000008f; border-radius: 50%;">0</button> Location en
                                        attente
                                      </p>
                                ...
                                <div class="card-body">
                                  <div class="row">
                                    ...
                                    <div class="col-md-12 text-start">
                                      <p class="text-white">
                                        <button class="btn btn-primary border-0 text-white"
                                          style="background: #0000008f; border-radius: 50%;">0</button> Locations
                                        reportées
                                      </p>
                                          ...
                                          <div class="col-md-6 text-end">
                                            <div class="row">
                                              <div class="col-4 text-end">
                                                <h6 style=" margin-top: 28px; font-size: 13px; color:rgb(247 127 0);">
                                                  Attente
                                                </h6>
                                              </div>
                                              <div class="col-8">
                                            ...
                                            <div class="row g-0" style="margin: 10px;">
                                              ...
                                              <div class="col-md-6">
                                                ...
                                                <div class="card-body">
                                                  ...
                                                  <p class="card-text"
                                                    style="background: #efefef; padding: 4px; border-radius: 5px; font-size: 12px; margin-top: -15px;">
                                                  ...
                                                  <p class="card-text"
                                                    ...
                                                    <strong>Caterpillar </strong> | <strong> 2022 </strong>
                                                  </p>
                                                  <hr>
                                                  <p class="card-text"
                                                    style="font-size: 13px; margin-top: -8px; margin-bottom: -8px;">
                                              ...
                                              <div class="col-md-6">
                                                <img src="/public/assets/img/car2.jpg"
                                                  ...
                                                  <div class="row">
                                                    <div class="col-md-6">
                                                      <button class="btn btn-primary w-75"
                                                        style="background: red; border-color:red;">Rejeter</button>
                                                    </div>
                                                    <div class="col-md-6 text-end">
                                                      <button class="btn btn-primary w-75"
                                                        style="background: #219935; border-color:#219935;">Valider</button>
                                                    </div>
                                                  </div>
                                                ...
                                                <div class="card-body">
                                                  ...
                                                  <div class="row">
                                                    ...
                                                    <div class="col-md-12 text-center">
                                                      <button class="btn btn-primary"
                                                        style="background:  #219935; border-color:#219935;">Annuler</button>
                                                    </div>
                                                  </div>
                                              ...
                                              <div class="col-md-12">
                                                <div class="card-body">
                                                  ...
                                                  <div class="row">
                                                    <div class="col-md-6">
                                                      <button class="btn btn-primary w-75"
                                                        style="background: white; border-color: #219935; color: #219935;">Annuler</button>
                                                    </div>
                                                    <div class="col-md-6">
                                                      <button class="btn btn-primary"
                                                        style="background:  #219935; border-color:#219935;">Procéder au
                                                        paiement</button>
                                                    </div>
                                                  </div>
                                            ...
                                            <div class="row g-0" style="margin: 10px;">
                                              ...
                                              <div class="col-md-6">
                                                ...
                                                <div class="card-body">
                                                  ...
                                                  <p class="card-text"
                                                    style="font-size: 13px; margin-top: -8px; margin-bottom: -8px;">
                                                    <strong>Hyundai </strong> | <strong> Santafe 2022 </strong>
                                                  </p>
                                                  <hr>
                                                  <p class="card-text"
                                                    style="font-size: 13px; margin-top: -8px; margin-bottom: -8px;">
                                              ...
                                              <div class="col-md-12">
                                                <div class="card-body">
                                                  <p class="card-text"
                                                    style="font-size: 13px; margin-top: -32px; margin-bottom: -8px;">
                                                    Retrait | <strong>2023-07-29 </strong> | <strong>12h 43 min</strong>
                                                  </p>
              ...
              <div class="tab-pane fade" id="categorie-tab-pane" role="tabpanel" aria-labelledby="categorie-tab"
                ...
                <div class="row mt-4">
                  ...
                  <div class="col-md-6 text-end">
                    ...
                    <!-- Modal -->
                    <div class="modal fade" id="exampleModaled" tabindex="-1" aria-labelledby="exampleModalLabeled"
                      aria-hidden="true">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header">
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        ...
                        <div class="card mb-4 rounded-1 shadow-sm border-primary" style="border-color:#219935 !important">
                          <div class="card-header py-3 text-bg-primary border-primary"
                            style="background:#219935 !important ; border-color:#219935 !important">
                            <h4 class="my-0 fw-normal text-center">Vip</h4>
                          </div>
                          <div class="card-body">

                            <ul class="list-unstyled mt-3 mb-4">
                              <li> <img src="/public/assets/img/icone/yes.png" alt="" class="img-fluid"
                                  style=" margin-top: -4px;"> Creation de compte</li>
                              <li class="mt-3"> <img src="/public/assets/img/icone/yes.png" alt="" class="img-fluid"
                                  style=" margin-top: -4px;"> Présence sur la liste des prestataires</li>
                              <li class="mt-3"> <img src="/public/assets/img/icone/yes.png" alt="" class="img-fluid"
                                  style=" margin-top: -4px;"> En vedette sur la pages d'accueil</li>
                              <li class="mt-3"> <img src="/public/assets/img/icone/yes.png" alt="" class="img-fluid"
                                  style=" margin-top: -4px;"> Une espace publicitaire </li>
                              <li class="mt-3"> <img src="/public/assets/img/icone/yes.png" alt="" class="img-fluid"
                                  style=" margin-top: -4px;"> Mise en avant d’un véhicule ou d’une destination </li>
                              <li class="mt-3"> <img src="/public/assets/img/icone/yes.png" alt="" class="img-fluid"
                                  style=" margin-top: -4px;"> Promotion d’une destination ou d’un véhicule </li>
                            </ul>
                            <h4 style="font-size: 18px; color: #219935; text-align: center;">Abonnement mensuel de 30 000
                              par mois </h4>
                            <div class="row">
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="card mb-4 rounded-1 shadow-sm border-primary" style="border-color:#219935 !important">
                          <div class="card-header py-3 text-bg-primary border-primary"
                            style="background:rgb(62 66 63) !important ; border-color:#219935 !important">
                          ...
                          <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                              ...
                              <li class="mt-3"> <img src="/public/assets/img/icone/yes.png" alt="" class="img-fluid"
                                  style=" margin-top: -4px;"> Présence sur la liste des prestataires</li>
                              <li class="mt-3"> <img src="/public/assets/img/icone/no.png" alt="" class="img-fluid"
                                  style=" margin-top: -4px;"> En vedette sur la pages d'accueil</li>
                              <li class="mt-3"> <img src="/public/assets/img/icone/no.png" alt="" class="img-fluid"
                                  style=" margin-top: -4px;"> Une espace publicitaire </li>
                              <li class="mt-3"> <img src="/public/assets/img/icone/no.png" alt="" class="img-fluid"
                            ...
                            <h4 style="font-size: 18px; color: #219935; text-align: center;">Abonnement de 20 000 par mois
                            </h4>
                            <div class="row">

                              <div class="col-md-12 text-center">
                                <button type="button" class=" btn btn-primary text-center"
                                  style="background: #219935; border-color: #219935;">Sélectionner</button>
                              </div>
                            </div>
              ...
              <div class="tab-pane fade" id="demande-tab-pane" role="tabpanel" aria-labelledby="demande-tab" tabindex="0">
                <div class="row mt-5">
                  <div class="col-md-6">
                    <!-- Button trigger modal -->
                    <button type="button" class="btn btn-primary w-100 text-start" data-bs-toggle="modal"
                      data-bs-target="#exampleModal10"
                      style="background:white !important;box-shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.25);  border: none; ">
                          ...
                          <div class="modal-body">
                            <form class="row g-3">
                              ...
                              <div class="col-md-12">
                                ...
                                <textarea class="form-control" id="validationTextarea" placeholder="Reponse"
                                  required></textarea>
                              </div>

                              <div class="col-12 text-center">
                                <button type="submit" class="btn btn-primary"
                                  style="background: #219935 ; border-color:#219935;">Repondre</button>
                              </div>
                            </form>
                          </div>
              ...
              <div class="tab-pane fade" id="politique-tab-pane" role="tabpanel" aria-labelledby="politique-tab"
                ...
                <div class="row mt-4">
                  ...
                  <div class="col-md-6 text-end">
                    <!-- Button trigger modal -->
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModalede"
                      style=" background-color: #219935; border-color: #219935;">
                      <img src="/public/assets/img/icone/plus.png" class="img-fluid " alt="..."> Ajouter
                    </button>

                    <!-- Modal -->
                    <div class="modal fade" id="exampleModalede" tabindex="-1" aria-labelledby="exampleModalLabelede"
                      aria-hidden="true">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header">
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="row">
                              <div class="col-md-12">
                                <button class="btn btn-primary"
                                  style="background: #219935; border-color : #219935">Modifier</button>
                                <button class="btn btn-primary"
                                  style="background-color:red; border-color:red; margin-left: 10px;">Supprimer</button>
                              </div>
              ...
              <div class="tab-pane fade" id="activite-tab-pane" role="tabpanel" aria-labelledby="activite-tab"
                ...
                <div class="row mt-4">
                  ...
                  <div class="col-md-6 text-end">
                    ...
                    <!-- Modal -->
                    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabeled"
                      aria-hidden="true">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header">
                                    ...
                                    <div class="col-md-6">
                                      <div class="card mb-3 border-0" style="max-width: 540px; background: #fafafa;">
                                        <div class="row g-1">
                                          <div class="col-md-4">
                                            <img src="/public/assets/img/avatars/1.png" alt
                                              class="w-px-40 h-auto rounded-circle" style="width: 90px;" />
                                          </div>
                                          <div class="col-md-8">
                                            <div class="card-body">
                                      ...
                                      <div class="col-md-12">
                                        <div class="card-body">
                                          <p class="card-text"
                                            ...
                                            <strong>Jours du voyages : </strong> à <strong>12h 43 min</strong>
                                          </p>

                                          <hr>
                                          <p class="card-text"
                                            style="font-size: 13px; margin-top: -8px; margin-bottom: -8px;">Retrait à
                                            <strong>Aéroport : </strong> retour le <strong>2023-07-29</strong>
                                          </p>
                                          <hr>

                                          <p class="card-text"
                                            style="font-size: 13px; margin-top: -8px; margin-bottom: -8px;">
                                            <strong>Nombres de jours de location </strong> 5 jours
                                          </p>
                                          <hr>
                                          <!-- <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p> -->
                                        </div>
                          ...
                          <div class="col-md-6 text-end">
                            <a v-bind:href="'/formulaire_reservation'" id="a_compagnie">
                              <button class="btn btn-primary" style="background-color: rgb(33 153 53);
                                      border-color:rgb(33 153 53);  margin-top: -8px;"><img
                                  src="/public/assets/img/icone/plus.png" class="img-fluid " alt="..."> Demander un
                                retrait </button>
                            </a>
                          </div>
                        </div>
                      ...
                      <div class="col-md-6">
                        <div class="row">
                          <div class="col-md-12 mb-4" style="box-shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.25);">
                            <div class="row">
                              <div class="col-md-8">
                                <p style="font-size: 17px;font-weight: 600;">Paiement pour la location de Toyota yaris
                                </p>
                              </div>
                              <div class="col-md-4">
                            ...
                            <div class="row mb-2">
                              <div class="col-md-8">
                                <p>Montant | <strong> <img src="/public/assets/img/icone/circle.png" alt=""> 12000
                                    FCFA</strong></p>
                              </div>
                              <div class="col-md-4">
                                <button class="btn btn-primary" style=" background: #219935; border-color: #219935;">
                                  Solde : 12000 F</button>
                              </div>
                            </div>
              ...
              <div class="tab-pane fade" id="collaborateur-tab-pane" role="tabpanel" aria-labelledby="collaborateur-tab"
                tabindex="0">
                <div class="row mt-5">
                  <div class="col-md-6">
                    <div class="card mb-3 border-0"
                      style="max-width: 540px; background: #f6f8fb; padding: 16px; border-radius: 5px;">
                      <div class="row g-0">
                        <div class="col-md-4">
                          <img src="/public/assets/img/avatars/1.png" alt class="w-px-40 h-auto rounded-circle"
                            style="width: 140px;" />
