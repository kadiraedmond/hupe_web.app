                          ...
                          <div class="card-body">
                            <div class="row">
                              ...
                              <div class="col-md-6 mt-4 text-end">
                                <router-link to="/detail_vente_engin">
                                  <button type="button" class="btn btn-primary" style=" background-color: white;   border-color: #219935; color: #219935;">
                                   Voir plus
                                   </button>
                                </router-link>
                                              ...
                                              <div class="col-md-6">
                                               ...
                                               <p class="card-text" style="background: #efefef; padding: 4px; border-radius: 5px; font-size: 12px; margin-top: -15px;">
                                                  ...
                                                  <p class="card-text"
                                                    ...
                                                    Achat   | <strong style="color:#219935">En attente </strong> </p>
                                                  <hr>
