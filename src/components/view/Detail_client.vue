...
<section id="portfolio-details" class="portfolio-details" style="margin-top: 0px;">
    <img src="assets/img/cari.jpg" alt="" class="img-fluid w-100" style="height: 380px; object-fit: cover;">
</section>
              ...
              <div class="row mt-4">
                  <div class="col-md-6">
                    <div class="card mb-3" style="max-width: 540px;">
                      <div class="row g-0">
                        <div class="col-md-4">
                          <img src="assets/img/car2.jpg" class="img-fluid rounded-start" alt="..." style="height: 100%; object-fit: cover;">
                        </div>
                        <div class="col-md-8">
                          <div class="card-body">
                            <div class="row">
