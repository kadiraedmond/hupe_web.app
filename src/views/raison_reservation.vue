...
<template>
    ...
    <section id="breadcrumbs" class="breadcrumbs">
        <div class="container">
          ...
          <ol>
            <li> <router-link to="/" style="color: #219935;" >Réservation de tickets</router-link></li>
            <li>Annuler</li>
          </ol>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 text-end">
                                            <div class="row">
                                                ...
                                                <div class="col-4"></div>
                                                <div class="col-4">
                                                    <input v-model="option" class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios" value="Je reporte mon voyage">
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6 text-end">
                                            <div class="row">
                                                ...
                                                <div class="col-4"></div>
                                                <div class="col-4">
                                                    <input v-model="option" class="form-check-input" type="radio" name="exampleRadios" id="exampleRadios3" value="Changement de destination">
                                                </div>
                                            </div>
