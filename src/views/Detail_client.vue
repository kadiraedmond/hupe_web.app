...
const getPolitiques = async () => {
  const q = query(
    politiqueColRef,
    where("compagnie_uid", "==", `${companieId}`)
  );
            ...
            <div class="tab-content" id="myTabContent">
              ...
              >
                <div v-if="companieStore.companieCars.length > 0">
                  <div class="row mt-4">
                    <div
                      class="col-md-6 mb-2"
                      v-for="(car, i) in companieStore.companieCars"
                      :key="i"
                    >
                      <div class="card mb-3">
                        <div class="row g-0">
                              ...
                              <div class="row g-1">
                                  ...
                                  <div class="row mt-2">
                                    ...
                                    <div class="col-6">
                                      <p
                                        ...
                                        "
                                      >
                                        <strong> Vers l'intérieur </strong>
                                        <br />
                                ...
                                <div class="col-md-12 mt-2 text-start">
                                  <div class="row">
                                    ...
                                    <div class="col-6">
                                      <router-link
                                        :to="`/detail_vehicule_location/${encryptParam(
                                          companieId
                                        )}/${encryptParam(car.uid)}`"
                                      >
                                        <button
                                          type="button"
                                          class="btn btn-primary"
              ...
              >
                <div v-if="promotionStore.companiePromotionCars.length > 0">
                  <div
                    class="row row-cols-1 row-cols-md-2 row-cols-lg-3 mt-4 g-4"
                  >
                    <div
                      class="col"
                      v-for="(
                        promoCar, i
                      ) in promotionStore.companiePromotionCars"
                      :key="i"
                    >
                      <div
                        class="card border-0"
                      ...
                      >
                        ...
                        >
                          ...
                          <button class="btn btn-primary" id="badges0121">
                            {{ promoCar.vehicule }} {{ promoCar.modele }}
                            {{ promoCar.anne_vehicule }}
                          </button>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="row mt-4">
                    ...
                    <div class="col-md-6">
                      <div class="card text-center border-0">
                        <div class="text-center">
                          <img
                            src="/assets/img/icone/promo.png"
                            alt=""
                            class="img-fluid w-50"
                          />
                        </div>
                        ...
                        <div class="col-md-9">
                          <div class="card-body">
                            <div class="row">
                              <div class="col-md-4">
                                <h6 id="h6">
                                  <i class="bx bx-car"></i> Raison sociale
                                </h6>
                                <p>
                                  {{ companieStore.companie.raison_social }}
                                </p>
                              ...
                              <div class="col-md-4">
                                <h6 id="h6">
                                  <i class="bx bx-user"></i> Responsable
                                </h6>
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-4">
                                <h6 id="h6">
                                  <i class="bx bx-map-pin"></i> Localisation
                                </h6>
                                <p>
                                  {{ companieStore.companie.latitude }}
                                  {{ companieStore.companie.longitude }}
                                </p>
                              </div>
                            </div>
                            <hr />
