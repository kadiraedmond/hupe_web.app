...
const reserver = async (car) => {
  ...
  const Data = { 
    ...
    identite_image_url: permis.value ? permis.value : '',
    ...
    <div class="container">
      ...
      <div class="row row-cols-1 row-cols-md-4 g-4">
        <div class="col" v-for="(car, i) in autresVehicules" :key="i">
          ...
          >
            <router-link @click="goToRelatedCar(car.uid)" to=""> 
              <img
                :src="car.vehicule_image_url"
                class="card-img-top"
                alt="..."
                style="border-radius: 10px 10px 0px 0px; height: 150px"
              />
            </router-link>
            <button
              class="btn btn-primary"
              ...
              <router-link to="/details_vente_engin">
                <div class="row">
                  <div class="col-md-12">
                    ...
                    >
                      {{ car.vehicule }} - {{ car.modele }} - {{ car.anne_vehicule }}
                    </h5>
                  </div>
                </div>
              </router-link>
