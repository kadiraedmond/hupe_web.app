      ...
      <section id="portfolio-details" class="portfolio-details">
          <div class="container">
              ...
              <div class="row no-gutters mt-4">
                  ...
                  <div class="col-md-6" style="text-align: justify; border: 1px solid #efefef; border-radius: 5px; width: 40% !important;">
                    <div class="row">
                        ...
                        <div class="col-md-12" style="font-size: 14px;">
                            <p data-aos=" -up">
                                Pour créer un compte Google, vous devez accepter les <router-link to='/' >  Termes & Conditions d'utilisation </router-link> ci-dessous. 
                                
                            </p>

                            <p data-aos=" -up">
                                De plus, lorsque vous créez un compte, nous traitons vos informations comme décrit dans nos <router-link to='/' >Politiques de confidentialité</router-link> ,
                            </p>
                        </div>
                        <div class="col-md-12" style="font-size: 14px;">
                            ...
                            <p data-aos=" -up">Comment nous collectons les données Nous pouvons collecter des données de différentes manières, notamment lorsque vous créez un compte, effectuez une réservation, utilisez notre application, communiquez avec notre service client, ou interagissez avec notre site web. 
