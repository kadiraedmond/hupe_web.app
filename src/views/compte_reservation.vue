...
const companieId = "f3Xb6K3Dv9SHof3CkkRbF8hE6Gl1";
...
const getCompanie = async () => {
  const q = query(companieColRef, where("uid", "==", `${companieId}`));
  const snapshot = await getDocs(q);
  snapshot.docs.forEach((doc) => companie.value.push({ ...doc.data() }));
  // console.log(companie.value);
};
...
<template>
  <main id="main">
    ...
    >
      <img
        :src="companie[0].imageCouvertureUrl"
        alt=""
          ...
          <div class="col-md-6">
            <div class="card mb-3 border-0" style="max-width: 540px">
              <div class="row g-0">
                ...
                <div class="col-md-8">
                  <div class="card-body">
                    <h5 class="card-title">{{ companie[0].raison_social }}</h5>
                    <p class="card-text">{{ companie[0].description }}</p>
                    <p class="card-text">{{ companie[0].description }}</p>
                  </div>
                </div>
              </div>
          ...
          <div class="col-lg-12">
            ...
            <div class="tab-content" id="myTabContent">
              ...
              >
                ...
                <div  class="row mt-4">
                  <div v-for="(reservation, index) in reservations" :key="index" class="col-md-6 my-3">
                    <div class="card h-100" style="max-width: 540px">
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="col-md-6 mt-2">
                            <p><strong>Lieu de départ |</strong> {{ reservation.lieu_depart }}</p>
                          </div>

                          <div class="col-md-6 mt-2">
                            <p><strong>Destinations |</strong> {{ reservation.destination }}</p>
                          </div>

                          <div class="col-md-6 mt-2">
                            <p><strong> Heure de départ |</strong> {{ reservation.heure_depart }}</p>
                          </div>

                          <div class="col-md-6 mt-2">
                            <p><strong>Convocation |</strong> NaN</p>
                          </div>

                          <div class="col-md-6 mt-3">
                            <p><strong>Escale | </strong> {{ reservation.escale }}</p>
                          </div>

                          <div class="col-md-6 mt-3">
                            <p><strong>Jours de voyage |</strong> {{ reservation.date_depart }}</p>
                          </div>
                        </div>
                                  ...
                                  <div class="accordion-item">
                                    ...
                                    >
                                      <button
                                        ...
                                        aria-expanded="false"
                                        aria-controls="flush-collapseTh"
                                        id="reser"
                                      >
                                        <div
                                          class="row"
                                    ...
                                    <div
                                      id="flush-collapseTh"
                                      class="accordion-collapse collapse"
                                      aria-labelledby="flush-headingTh"
                                      data-bs-parent="#accordionFlushExample"
                                    >
                                      <div
                                        class="accordion-body"
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                              ...
                              <li class="mt-3">
                                <img
                                  ...
                                  style="margin-top: -4px"
                                />
                                Mise en avanr d'une destination ou d'un véhicule
                                en location sur la page d'accueil
                              </li>
                            </ul>
                            <h4
                              style="
                                    ...
                                    <div class="row g-0" style="margin: 10px">
                                      <div class="col-md-6">
                                        <div class="card-body">
                                          ...
                                          >
                                            <strong
                                              >Location Hyundai Santa fe 2022
                                            </strong>
                                          </p>
                                          <hr />
                                          <p
                                      ...
                                      <div class="col-md-12">
                                        <div class="card-body">
                                          ...
                                          >
                                            Retrait à
                                            <strong>Aéroport : </strong> retour
                                            le <strong>2023-07-29</strong>
                                          </p>
                                          <hr />
