            ...
            <div class="row">
                <div class="col-md-12">
                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist"
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="pills-reservation-tab" data-bs-toggle="pill"
                                data-bs-target="#pills-reservation" type="button" role="tab"
                                aria-controls="pills-reservation" aria-selected="false">
                                Reservation de ticket
                            </button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="pills-location2-tab" data-bs-toggle="pill"
                                data-bs-target="#pills-location2" type="button" role="tab" aria-controls="pills-location2"
                                aria-selected="false">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="pills-achat-tab" data-bs-toggle="pill"
                                data-bs-target="#pills-achat" type="button" role="tab" aria-controls="pills-achat"
                                aria-selected="false">
                                Achat de véhicule
                            </button>
                        </li>
                    ...
                    <div class="row">
                                ...
                                <div class="col">
                                    <div class="card h-100" id="compagnie_card"
                                        ...
                                        <router-link to="/details_location_engin" style="color: #000">
                                            <img src="/assets/img/car2.jpg" class="card-img-top" alt="..." style="
                                            ...
                                            <div class="row row-cols-1 row-cols-md-4 g-4 mb-3" id="">
                                                <div class="col">
                                                    <div class="card h-100" id="compagnie_card"
                                                        style="background: #f9f9f9; box-shadow: none">
                                                        <router-link to="/details_location_engin" style="color: #000">
                                                            <img src="/public/assets/img/car2.jpg" class="card-img-top"
                                                                alt="..." style="
                          border-radius: 10px 10px 0px 0px;
                          max-height: 174px;
                          object-fit: cover;
                        " />
                                                            ...
                                                            <router-link to="/detail" style="color: #000">
                                                                <div class="row mt-2">
                                                                    ...
                                                                    <div class="col-md-5 text-end">
                                                                        <boutton class="btn btn-primary" style="
                                background: white;
                                border-color: white;
                                border-radius: 30px;
                                color: #219935;
                              ...
                              ">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-4 text-center mt-2">
                                                                    <i class="bx bx-car"
                                                                        style="color: #8b8b8b; font-size: 21px"></i>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="row row-cols-1 row-cols-md-4 g-4 mb-3" id="">
                                        <div class="col">
                                            <div class="card h-100" id="compagnie_card"
                                                style="background: #f9f9f9; box-shadow: none">
                                                <router-link to="/details_location_engin" style="color: #000">
                                                    <img src="/public/assets/img/car2.jpg" class="card-img-top" alt="..."
                                                        style="
                                        border-radius: 10px 10px 0px 0px;
                                        max-height: 174px;
                                        object-fit: cover;
                          ...
                          ">
                                ...
                                <div class="tab-pane fade" id="pills-reservation" role="tabpanel"
                                    aria-labelledby="pills-reservation-tab" tabindex="0">
                                    <div class="row row-cols-1 row-cols-md-4 g-4 mb-3" id="">
                                        <div class="col">
                                            <div class="card h-100" id="compagnie_card"
                                                style="background: #f9f9f9; box-shadow: none">
                          ...
                          ">
                                ...
                                <div class="tab-pane fade" id="pills-location2" role="tabpanel"
                                    aria-labelledby="pills-location2-tab" tabindex="0">
                                    <div class="row row-cols-1 row-cols-md-4 g-4 mb-3" id="">
                                        <div class="col">
                                            <div class="card h-100" id="compagnie_card"
                                                style="background: #f9f9f9; box-shadow: none">
